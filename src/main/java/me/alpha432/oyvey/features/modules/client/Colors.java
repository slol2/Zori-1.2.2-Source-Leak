...
public class Colors extends Module {
    ...
    public Colors() {
        super("RainbowPrefixColors", "Universal colors.", Module.Category.CLIENT, true, false, true);
        INSTANCE = this;
    }
    ...
    public void onTick() {
        ...
        if (ClickGui.getInstance().rainbow.getValue().booleanValue()) {
            OyVey.colorManager.setColor(INSTANCE.getCurrentColor().getRed(), INSTANCE.getCurrentColor().getGreen(), INSTANCE.getCurrentColor().getBlue(), ClickGui.getInstance().hoverAlpha.getValue());
        }
    }
